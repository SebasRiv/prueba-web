...
<body>
    ...
    <div class="container">
        <?php !empty($show_form_reservas) ? require 'app/views/Reservas/reservas_form.php': '' ?>
        <?php !empty($show_reservas) ? require 'app/views/Reservas/reservas_list.php' : '' ?>
        <?php !empty($show_boletos) ? require 'app/views/Boletos/boletos_list.php' : '' ?>
